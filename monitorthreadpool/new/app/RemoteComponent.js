...
const RemoteComponent = props => {
     ...
     return (            
          isValidOperation(constants.OPERATIONS.MONITORTHREADPOOL_OPERATION,true,nls("errorMessages.UnauthorizedOperation"),props.Operations)?
          <MonitorThreadPoolTabStrip externalProps={props}/>
          :<div></div>                                          
     );
