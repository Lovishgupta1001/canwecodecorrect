...
({ 
  paths: { 
    ...
    "Components/Activities/FileSystemConnComponent/FileSystemConnComponent": "Components/Activities/FileSystemConnComponent/FileSystemConnComponent" 
  }, 
  appDir: "./", 
  useStrict: true, 
  ...
  dir: "./../../../_Components/Activities/FileSystemConnComponent", 
  modules: [{ 
    //instead of Logs use WiodgetNameEdit ( this should be same as WidgetNameEdit.js file omitting the .js extension 
    name: "Components/Activities/FileSystemConnComponent/FileSystemConnComponent", 
