...
define(function (require) {
    ...
    var TransportManager = {
            ...
            var dataSource = new uilayer.data.DataSource({
                transport: {
                    read: function (options) {
                        AjaxUtility.commonAjaxRequest("GET", "activities/invokeopcua/fetchOPCUATransportList", null, "json")
                            .done(function (data) {
        ...
        testTransportById: function (transportId, globalSelf) {
            ...
            var url = "activities/invokeopcua/testTransportById?transportId=" + encodeURIComponent(transportId);
