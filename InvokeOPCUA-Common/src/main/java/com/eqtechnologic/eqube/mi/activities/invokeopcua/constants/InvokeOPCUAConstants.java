...
public final class InvokeOPCUAConstants {
    ...
    public static final String ERR_SEL_TRANSPORT = "invokeopcua.selTransport";
    ...
    public static final String ERR_TRANSPORT_NOT_FOUND = "invokeopcua.transportNotFound";
    public static final String ERR_TRANSPORT_FRAMEWORK_ERROR = "invokeopcua.transportFrameworkError_transport";
}
